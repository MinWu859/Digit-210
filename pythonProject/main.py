...
archive_url = "https://gzc5211.github.io/Hilaire-Belloc-1-Cautionary-Tales-for-Children/"
...
def get_radioplays():
    ...
    # filter the image
    src = [archive_url + image['src'] for image in images]
...
# To do that, adapt the script from grimmScraper
    for href in hrefs:
        ...
        fileDeposit = os.path.join(workingDir, 'images', file_name)
        print(fileDeposit)
